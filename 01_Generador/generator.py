        ...
        while start < end:
            ...
            for client_id in clients:
                    for device in clients[client_id]:
                        kw = "0"
                        if device[1] == "TV" and hour in [14,15,16,17,18,19,20,21,22]:
                            kw = random.uniform(0.40, 0.80)
                        elif device[1] == "horno" and hour in [14,15,16,17,18,19,20,21,22]:
                            kw = random.uniform(1.20,1.40) 
                        elif device[1] == "microondas" and hour in [14,15,16,17,18,19,20,21,22]:
                            kw = random.uniform(1.00, 1.50)
                        elif device[1] == "lavadora" and hour in [14,15,16,17,18,19,20,21,22]:
                            kw = random.uniform(1.80, 2.20)
                        elif device[1] == "nevera" and hour in [14,15,16,17,18,19,20,21,22]:
